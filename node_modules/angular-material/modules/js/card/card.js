 ...
 *    - `md-name` - Class for the card name
 *    - `md-subhead` - Class for the card sub header
 * * `<img>` - Image for the card
 * * `<md-card-name>` - Card content name
 *  - `<md-card-name-text>`
 *    - `md-headline` - Class for the card content name
 *    - `md-subhead` - Class for the card content sub header
 *  - `<md-card-name-media>` - Squared image within the name
 ...
 * </hljs>
 *
 * ### Card with header, image, name actions and content
 * <hljs lang="html">
 * <md-card>
 *   <md-card-header>
 *     <md-card-avatar>
