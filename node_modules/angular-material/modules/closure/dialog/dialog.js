 ...
 *
 * - $mdDialogPreset#name(string) - Sets the alert name.
 ...
 *
 * - $mdDialogPreset#name(string) - Sets the confirm name.
 ...
 * Additionally, it supports the following methods:
 *
 * - $mdDialogPreset#name(string) - Sets the prompt name.
...
function MdDialogProvider($$interimElementProvider) {
  ...
  return $$interimElementProvider('$mdDialog')
    ...
    .addPreset('alert', {
      methods: ['name', 'htmlContent', 'textContent', 'content', 'ariaLabel', 'ok', 'theme',
          'css'],
      options: advancedDialogOptions
    })
    .addPreset('confirm', {
      methods: ['name', 'htmlContent', 'textContent', 'content', 'ariaLabel', 'ok', 'cancel',
          'theme', 'css'],
      options: advancedDialogOptions
    })
    .addPreset('prompt', {
      methods: ['name', 'htmlContent', 'textContent', 'initialValue', 'content', 'placeholder', 'ariaLabel',
          'ok', 'cancel', 'theme', 'css'],
      options: advancedDialogOptions
    });
  ...
  function advancedDialogOptions($mdDialog, $mdConstant) {
    return {
      template: [
        ...
        '    <h2 class="md-name">{{ dialog.name }}</h2>',
