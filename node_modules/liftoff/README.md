...
Sugar for setting `processName`, `moduleName`, `configName` automatically.
...
Sets what the [process name](http://nodejs.org/api/process.html#process_process_name) will be.
